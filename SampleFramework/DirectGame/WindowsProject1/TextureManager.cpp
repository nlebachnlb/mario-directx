...
void TextureManager::Initialization()
{
	...
	Add(TEXTURE_DIALOG,		ToLPCWSTR(root.GetSourcePathOf(CATEGORY_TEXTURE, TEXTURE_DIALOG)), D3DCOLOR_XRGB(253, 253, 253));
	Add(TEXTURE_MENU,		ToLPCWSTR(root.GetSourcePathOf(CATEGORY_TEXTURE, TEXTURE_MENU)), D3DCOLOR_XRGB(254, 254, 254));
}
